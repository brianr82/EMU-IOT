...
class IoTExperimentBinarySearch(IoTExperiment):
    def __init__(self):
        IoTExperiment.__init__(self)

        self.IoTBinarySearchLoadbalancer = None
        self.IoTBinarySearchMonitorManager = None
    ...
    def __configureNetwork(self):
        ...
        self.IoTBinarySearchLoadbalancer = iot_lb_1
    ...
    def __configureMonitor(self):
        ...
        '''
        print ('Starting monitor for: ' + self.IoTBinarySearchLoadbalancer.parent_IoTNetwork.get_IoTNode ('Kafka').NodeName)
        KafkaMonitor = IoTMonitor (self.IoTBinarySearchLoadbalancer.parent_IoTNetwork.get_IoTNode ('Kafka').NodeDockerRemoteClient,
        ...
        print ('Starting monitor for: ' + self.IoTBinarySearchLoadbalancer.parent_IoTNetwork.get_IoTNode ('Spark').NodeName)
        Spark_Monitor = IoTMonitor (self.IoTBinarySearchLoadbalancer.parent_IoTNetwork.get_IoTNode ('Spark').NodeDockerRemoteClient,
        ...
        print ('Starting monitor for: ' + self.IoTBinarySearchLoadbalancer.parent_IoTNetwork.get_IoTNode ('Cassandra').NodeName)
        Cassandra_Monitor = IoTMonitor (self.IoTBinarySearchLoadbalancer.parent_IoTNetwork.get_IoTNode ('Cassandra').NodeDockerRemoteClient,
        ...
        self.IoTBinarySearchMonitorManager = MonitorManager

        # set the monitor that you want to use to find the bottleneck
        # loop through list and find the monitor you need
        for monitor in self.IoTBinarySearchMonitorManager.IoTMonitorList:
    ...
    def __IoTNodeSetup(self):
        ...
        host_producer_list = self.IoTBinarySearchLoadbalancer.getIoTHostProducerList ()
        ...
        host_gateway_list = self.IoTBinarySearchLoadbalancer.getIoTHostGatewayList ()
    ...
    def __startMonitors(self):
        ...
        self.IoTBinarySearchMonitorManager.startAllMonitors ()
        time.sleep (10)
    ...
    def __executeWorkload(self):
        ...
        print ('...................................................................Starting BinarySearch Experiment')
        ...
        while True:
            if self.monitor_to_check.hostCPUUsage > self.targetCPUUtilization:
                ...
                if not_able_to_create:
                    ...
                    #self.DeviceServiceTemperature.removeVirtualIoTDevice(self.IoTBinarySearchLoadbalancer,self.IoTBinarySearchMonitorManager)
                    #self.DeviceServiceCamera.removeVirtualIoTDevice (self.IoTBinarySearchLoadbalancer, self.IoTBinarySearchMonitorManager)
                    break
            else:
    ...
    def __generateTestCase(self):
        ...
        if self.TestCaseCompleted == True:
            ...
            for i in range(0,iterations_per_case):
                #self.DeviceServiceTemperature.addVirutalIoTDevice (self.IoTBinarySearchLoadbalancer,self.IoTBinarySearchMonitorManager)
                #self.target_active_producers = self.target_active_producers + 1

                self.DeviceServiceCamera.addVirutalIoTDevice (self.IoTBinarySearchLoadbalancer, self.IoTBinarySearchMonitorManager)
                self.target_active_producers = self.target_active_producers + 1
    ...
    def __cleanUp(self):
        ...
        self.IoTBinarySearchMonitorManager.stopAllMonitors ()

        # wait for all threads to finish before ending the program
        print ('Joining Monitor Threads')
        self.IoTBinarySearchMonitorManager.joinThreads ()

        time.sleep (10)

        # kill the receivers after the experiment

        self.IoTBinarySearchLoadbalancer.remove_all_gateways ()
        self.IoTBinarySearchLoadbalancer.remove_all_iot_devices ()
